        ...
        <div class="container px-5 py-24 mx-auto">
            <div class="lg:w-4/5 mx-auto flex flex-wrap">
                ...
                <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                    ...
                    <div class="my-3">
                        <span class="inline-flex items-center px-3 py-0.5 rounded-full text-sm font-medium {{$product->stock > 0 ? 'bg-lime-100 text-lime-800' : 'bg-slate-400 text-slate-900'}}">
                    ...
                    <div class="flex border-t-2 border-gray-100 mt-6 pt-6">
                        ...
                        <a class="flex ml-auto text-white bg-lime-500 border-0 py-2 px-6 focus:outline-none hover:bg-lime-600 rounded">Comprar</a>
                    </div>
                </div>
            </div>
        </div>
